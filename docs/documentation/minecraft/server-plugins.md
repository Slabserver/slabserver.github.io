...
!!! info
    ...
    :material-sword: Plugin is used on Survival &nbsp; &nbsp; &nbsp; &nbsp; :material-brush: Plugin is used on Creative &nbsp; &nbsp; &nbsp; &nbsp;:material-tools: Plugin is used on Survival and Creative

    :material-account-edit-outline:{.staff} Plugin is written and maintained by the staff team &nbsp; &nbsp; :material-delete-clock-outline:{.deprecate} Plugin is deprecated and subject to future removal
...
:material-brush: SimpleBack  :material-account-edit-outline:{.staff}| Adds a `/back` command to return to your previous location |
...
| :material-tools: [Wrench](https://github.com/Slabserver/Wrench) :material-account-edit-outline:{.staff} | Provides easier rotation of a wide varity of blocks |
...
:material-brush: [WorldGuard Extra Flags](https://www.spigotmc.org/resources/worldguard-extra-flags.4823/) | Adds more granular permission settings for WorldGuard |
