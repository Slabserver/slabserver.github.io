...
-  We released the [Great Slabserver Poll 2026 results](../../../polls/2026.md), taking slightly longer than previous years in order to improve our graphs and visualisations for the results. Even so, Twist went above and beyond with his work on this, and appreciate the positive response we've received to how the results were shared this year.
    - We also hosted a **State of the Slab Live** to discuss some of the anonymised qualitiative feedback from The Great Slabserver Poll 2026 in more detail. The recording for this can be found [over on YouTube](https://www.youtube.com/playlist?list=PLAD59jwNidoAl1wpxzRyl1imds12-ppGW).
