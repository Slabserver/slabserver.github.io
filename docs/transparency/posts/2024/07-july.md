...
Monthly Paypal Donations¹| $83.44
Total Donations (Month)| $89.52
Existing Rollover Donations| $238.29
---|---
Dedicated Server Cost²| -$85.33
---|---
**Remaining Donation Funds**³   |  **$242.48**

---

### State of the Slab
State of the Slab resumes in [August 2024](08-august.md), owing to the huge amount of work that we had to focus on during June in order to end Season 3, migrate to a different dedicated server host, and begin Season 4.
